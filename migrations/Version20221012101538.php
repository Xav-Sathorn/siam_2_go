 ...
 */
final class Version20221012101538 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE purchase MODIFY purchased_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\'');
    }
